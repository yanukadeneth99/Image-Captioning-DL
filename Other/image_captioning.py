# -*- coding: utf-8 -*-
"""Image_Captioning_Latest_latest.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pluWur7u-lRklN4H6a6a5b2BAC8Jrj4n
...
"""You can download the features file from [here](https://github.com/yanukadeneth99/Image-Captioning-DL/releases/download/v1.1/features.pkl). Make sure to move it into the `export_model` folder. The file must be labelled as `features.pkl`."""
...
You can download the weights from [here](https://github.com/yanukadeneth99/Image-Captioning-DL/releases/download/v1.1/main_model_weights.hdf5).
"""
